...
namespace Com.IsartDigital.WoolyWay.Managers
{
    ...
    public partial class InputManager : Node
    {
        ...
        public override void _UnhandledInput(InputEvent @event)
        {
            ...
            isUpPressed = Input.IsActionJustPressed(MOVE_UP, true);
            isDownPressed = Input.IsActionJustPressed(MOVE_DOWN, true);
            isLeftPressed = Input.IsActionJustPressed(MOVE_LEFT, true);
            isRightPressed = Input.IsActionJustPressed(MOVE_RIGHT, true);
        }
